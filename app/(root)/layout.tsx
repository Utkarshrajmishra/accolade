...
export const metadata: Metadata = {
  ...
  description: "Turn LinkedIn job descriptions and your resume into personalized cold emails with the help of AI. Boost your outreach, stand out to recruiters, and land more interviews—effortlessly!",
};
